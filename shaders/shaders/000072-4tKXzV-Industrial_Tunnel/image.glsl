// Image (image) — Industrial Tunnel by Shane
// https://www.shadertoy.com/view/4tKXzV
...
// Better aesthetics, but doesn't show the tunnel as well... Either way, I 
// think the whole thing will need updating at some stage. :)
//#define DARK
...
void mainImage(out vec4 fragColor, in vec2 fragCoord){
    ...
    else if(svObjID==MTL) tx *= pathSp.y<0.? vec3(1.1, .8, .7)/2. : vec3(1.1, .8, .7)/4.;
