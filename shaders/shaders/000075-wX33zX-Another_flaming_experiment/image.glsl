// Image (image) — Another flaming experiment by mrange
// https://www.shadertoy.com/view/wX33zX
...
void mainImage(out vec4 O, vec2 C) {
  ...
  float 
    ...
    , t=iTime          // Current time for animations
    ; ++i<88.          
  ...
  O = tanh(o.xyzx/2E3);  // Compress bright values, output RGBA (xyzx creates alpha=x)
}