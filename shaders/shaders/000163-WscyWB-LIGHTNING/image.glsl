// Image (image) — LIGHTNING by alro
// https://www.shadertoy.com/view/WscyWB

/*
    For a full WebGL2 cloud renderer see https://al-ro.github.io/projects/cloud/
...
float lightRay(vec3 org, vec3 p, float mu, vec3 sunDirection){
