// Image (image) — Cloudy Sunrise on Alps Lake by lerrain
...
void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
    ...
    if (iMouse.z + iMouse.w > 0.) {
        ...
        ro = vec3(0, 20. + lk.y*lk.y * 1000., (0.5-lk.x) * 5000.);
        ...
        if (phase == 2) { //落日
            ro = vec3(1000.-time*8000., max(1200.-sin(PI*min(.5,time*.7))*1200., 20.), -100.-time*1000.);
