// Image (image) — one cube challenge - v3   (251) by FabriceNeyret2
// https://www.shadertoy.com/view/Xs33RH

// -11 by Xor  -3 by Coyote

#define L  *I ; o+= 2e-3 / length( clamp( dot(u-a,v=b-a)/dot(v,v), 0.,1.) *v - u+a )
#define P  ; c=r=I*r.yx; c.y=.7; b=c/=(4.+r.y) L;   b=a L;   a=c L;  a=c;
//#define P  ; b=c= vec2(r.x,.7)/(4.+r.y) L;   b=a L;   a=c L;  a=c; r= I*r.yx;
