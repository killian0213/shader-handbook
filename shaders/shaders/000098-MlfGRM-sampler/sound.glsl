...
float hh(float gt, float t) {
    float S = 0.;
    {
        ...
        // This is needed on Linux/Mesa amdgpu drivers to avoid rather harsh noise. Have no idea why.
        // It's been like that since forever.
        // Note that it removes -1..0 half of possible sample value
        // ¯\_(ツ)_/¯
        s = clamp(s, 0., 1.);
