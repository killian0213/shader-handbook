// Image (image) — Poincare Disc Animation by Shane
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    */
    ...
    for(int i = 0; i<=N; i++){
        ...
        // which I know how to do, but I couldn't be bothered right now. :D 
    ...
    // disc exterior... I'm still not sure whether it worked or not. :D
