...
// iq: I fixed and optimized the original shader. The idea of recursing
// a tree without a stack is a good one. In the context of raymarching,
// the pruning can be done also based on a screen space pixel coverage,
// but even then it's still too slow. But I made this variation anyways
// for bug fixing it and for further study.
