//  (image) — Soap bubbles 2D by foxes
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    vec4 e=vec4(noise3(vec3(uv*2.0,iTime*0.1)),noise3(vec3(uv*2.0+vec2(200.0),iTime*0.1)),noise3(vec3(uv*2.0+vec2(50.0),iTime*0.1)),0.0);
