// Image (image) — JFA Delaunay Video Filter by tomkh
...
#else
    vec4 video = 
      ( texture(iChannel1, p0 / iChannelResolution[1].xy ) +
        texture(iChannel1, p1 / iChannelResolution[1].xy ) +
        texture(iChannel1, p2 / iChannelResolution[1].xy ) +
        texture(iChannel1, p3 / iChannelResolution[1].xy ) ) * .25;
