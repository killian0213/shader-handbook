// Image (image) — GPU and OS detector v2 by archee
...
void mainImage( out vec4 O, vec2 uv )
{
    ...
    if (hash_runtime==0x76B5 || hash_runtime==0x00e2) { os=LINUX; gpu=AMD; gldx=GL;}// AMD GCN4
    ...
    if (hash_runtime==0xFB6F) { gpu=INTEL; } // Intel 12.gen (linux?)
